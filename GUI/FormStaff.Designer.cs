...
partial class FormStaff
{
    ...
    private Button btnStaffKembali, btnStaffHilang, btnStaffRestock;
    ...
    private void InitializeComponent()
    {
        ...
        btnStaffRestock = SmallBtn("Restock", 805, 46); btnStaffRestock.Click += btnStaffRestock_Click;
        ...
        panBukuTop.Controls.AddRange(new Control[] {
            ...
            btnStaffKembali, btnStaffHilang, btnStaffRestock
        });
